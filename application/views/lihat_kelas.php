	...
	<div class="container wrapsearch" style="background-color: #fefefe; border: 1px solid #f5f5f5; min-height:100vh">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-8 col-xs-offset-2">
				<hr>
				<h2 align="center">Siswa Kelas <?php foreach ($namakelas as $key){ echo $key['nama_kelas'];} ?></h2>
				<hr>
			</div>
		</div>
		<br>
		...
		<div class="row">
            ...
            <table class="table table-bordered table-hover table-striped"  cellspacing="0" width="100%" id="myTable">
                        ...
                        <a style="float:right" type="button" class="btn btn-info" href="<?php echo base_url(); ?>home/lihat">Kembali</a>
			</div>
    </div>
	</div>
 </div>
