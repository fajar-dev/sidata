      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-6">
          ...
          <div class="card-body text-center">
            ...
            <h5 class="fw-bold mb-4">Login Siswa</h5>
              <div id="output"></div>
              <div class="form-box">
                <form action="<?php echo base_url();?>login/login_siswa" method="post">
                    <input name="nisn" class="rounded" type="text" placeholder="NISN" autocomplete="off" autofocus="on" required> <br>
                    ...
                    <a href="<?php echo base_url();?>login/admin">Login Sebagai Admin</a> | <a href="<?php echo base_url();?>login/walikelas">Login Sebagai Walikelas</a>
                </form>
              </div>
